...
Version  : 6
Release  : 4
URL      : http://localhost/cgit/projects/clr-bundle-icons/snapshot/clr-bundle-icons-6.tar.bz2
Source0  : http://localhost/cgit/projects/clr-bundle-icons/snapshot/clr-bundle-icons-6.tar.bz2
...
export LANG=C
export SOURCE_DATE_EPOCH=1547821011
make  %{?_smp_mflags}
