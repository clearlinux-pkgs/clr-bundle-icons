...
Version  : 8
Release  : 6
URL      : http://localhost/cgit/projects/clr-bundle-icons/snapshot/clr-bundle-icons-8.tar.gz
Source0  : http://localhost/cgit/projects/clr-bundle-icons/snapshot/clr-bundle-icons-8.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1547823710
make  %{?_smp_mflags}
