...
Version  : 5
Release  : 3
URL      : http://localhost/cgit/projects/clr-bundle-icons/snapshot/clr-bundle-icons-5.tar.gz
Source0  : http://localhost/cgit/projects/clr-bundle-icons/snapshot/clr-bundle-icons-5.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1547584414
make  %{?_smp_mflags}
